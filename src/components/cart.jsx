...
const Cart = () => {
  ...
  // Ref to track processing state reliably
  ...
  const onScanSuccess = (decodedText) => {
    // If we're already processing, ignore new scans
    ...
    try {
      ...
      if (product) {
        ...
        setScanError(`Product not found: ${code}`);
      }
    } catch (error) {
      console.error("Scan processing error:", error);
      setScanError("Error processing scan. Please try again.");
    } finally {
      // Reset processing flags after delay
      setTimeout(() => {
  ...
  const toggleScanner = () => {
    ...
    setIsScannerExpanded(!isScannerExpanded);
  };
  ...
  return (
    <div className="CartWrapper">
      ...
      <div className={`scanner-section ${isScannerExpanded ? "expanded" : "collapsed"}`}>
        <div 
        ...
        >
          <h2 className="scanner-title">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor" d="M4 4h4v2H4V4m14 0v2h2v4h2V4h-4m-2 14h2v4h-2v-4M4 16v2h2v4h2v-4H4m0-2h4v2H4v-2M2 2v6h6V2H2m10 0v6h6V2h-6m6 16v6h-6v-6h6M2 16v6h6v-6H2Z"/>
            </svg>
            Scan Products
          </h2>
          <button className="scanner-toggle">
            {isScannerExpanded ? (
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="currentColor" d="m12 10.828l-4.95 4.95l-1.414-1.414L12 8l6.364 6.364l-1.414 1.414l-4.95-4.95Z"/>
              </svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="currentColor" d="m12 13.172l4.95-4.95l1.414 1.414L12 16l-6.364-6.364l1.414-1.414l4.95 4.95Z"/>
              </svg>
            )}
          </button>
        </div>
        ...
        {isScannerExpanded && (
          <div className="scanner-container">
            ...
            <BarcodeScanner
              ...
              isScanning={isScanning && !productsLoading && !isProcessingScan}
            />
